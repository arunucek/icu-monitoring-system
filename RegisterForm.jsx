...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // For now, store in localStorage until Supabase is integrated
    const userData = {
    ...
    toast({
      title: "Success",
      description: "Registration successful! Welcome to the dashboard.",
    });
      ...
      <Card className="w-full max-w-md overflow-hidden gradient-border">
        <CardHeader className="gradient-bg text-white text-center pb-8">
          ...
          <CardDescription className="text-white/80">
            Register to access the Medical ICU Dashboard
          </CardDescription>
        </CardHeader>
